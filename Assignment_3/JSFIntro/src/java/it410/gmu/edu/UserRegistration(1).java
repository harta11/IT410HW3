...
public class UserRegistration implements Serializable {
    ...
    //private String[] states = {"Mississipi", "Missouri", "Michigan", "Kansas", "Montana", "Kentucky"};
    ...
    public void registerUser() {
        ...
        System.out.println("Credit Hours = " + user.getCreditHours());
        ...
        {
            //No need to add student to the list
        }        
    ...
    {
        System.out.println("Row selected fromthe Data Table.");
